...
public class BookService {
    ...
    static {
        books.add(new Book("Jeff Sutherland","Scrum: The Art of Doing Twice the Work in Half the Time", "scrum.jpg", 1));
        books.add(new Book("Eric Ries","The Lean Startup: How Constant Innovation Creates Radically Successful Businesses", "lean.jpg", 4));
        books.add(new Book("Geoffrey A. Moore","Crossing the Chasm", "chasm.jpg", 5));
